...
/**
 * Set class that implements Set Interface.
 * 
...
public class HashSet<E> implements Set<E> {
	 ...
	 */
	public HashSet(Class<E[]> arrayType) {
	...
	/**
	 * adds an element to the set only if it is not already in the set.
	 * 
	 * @param e element to be added
	 * @return true if element is added, false if it is already in
	 */
	@Override
	...
	public void retainAll(Collection<E> c) {
		HashSetIterator iter = new HashSetIterator();
		HashSet<E> toBeRemoved = new HashSet<E>(arrayType);
		while(iter.hasNext()) {
			E current = iter.next();
